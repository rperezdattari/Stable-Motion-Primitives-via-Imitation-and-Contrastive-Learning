#
#  tsne_torch.py from https://github.com/mxl1990/tsne-pytorch
#
...
def tsne(X, no_dims=2, initial_dims=50, perplexity=30.0, eta=500, early_exaggeration=12.0, max_iter=1000):
    """
